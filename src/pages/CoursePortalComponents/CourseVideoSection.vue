...
<template>
  ...
  <div class="main-container" @mousemove="handleMouseMove">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="video-img">
          ...
          <img
            class="shape shape1"
            src="/Immagini/maxcoach-shape-05-150x150.png"
            alt=""
          />
          <img
            class="shape shape2"
          ...
          <div class="video-btn" @click="modalActive">
            <img
              ...
              alt=""
            />
            <img class="yt-logo" src="/Immagini/icon-youtube-play.png" alt="" />
          </div>
        </div>
        <!-- content section -->
        <div class="content">
          <div class="sub-title">GET STARTED <span>EFFORTLESSLY</span></div>
          <div class="title">
            Enjoy Our <br />
